...
<body>
  ...
  <header class="jumbotron back-image" style="background-image: url(images/Banner1.jpeg);">
    <div class="myclass mainHeading">
      <h1 class="text-uppercase text-danger font-weight-bold">Welcome to <br> Samriddh Kendra</h1>
      <p class="font-italic">A way to change the life of rural entrepreneur..!</p>
      <a href="Requester/RequesterLogin.php" class="btn btn-success mr-4">Login</a>
      <a href="#registration" class="btn btn-danger mr-4">Join Now</a>
    </div>
  ...
  <div class="container">
    ...
    <div class="jumbotron">
      <h3 class="text-center">Samriddh Kendra Services</h3>
      <p>
      Samriddh aims to deliver the digital financial services to the last mile of connectivity in India. We believe in inclusive growth and each of our initiatives is focused on generating employment by adopting and spreading benefits of digital era to the length and breadth of India.
  ...
  <div class="container text-center border-bottom" id="Services">
    ...
    <div class="row mt-4">
      <div class="col-sm-4 mb-4">
        ...
        <h4 class="mt-4"><a href="ayushman.php">Health Card services(Ayushman bharat)</a></h4>
      </div>
      <div class="col-sm-4 mb-4">
        <a href="#"><i class="fas fa-sliders-h fa-8x text-primary"></i></a>
        <h4 class="mt-4"><a href="#">Loans and Insurance services</a></h4>
      </div>
      <div class="col-sm-4 mb-4">
        <a href="#"><i class="fas fa-cogs fa-8x text-info"></i></a>
        <h4 class="mt-4"><a href="#">Credit card services</a></h4>
      </div>
    </div>
  </div> <!-- End Services -->
